...
public class UserServiceImpl implements UserService {
    ...
    /*@Override
    public int updateByPrimaryKey(Integer id, String username, String password, String email, String name, String address, String phone, String user_type) {
        return userDao.updateByPrimaryKey(id, username, password, email, name, address, phone, user_type);
    }*/
