...
import cn.edu.lingnan.exam.common.CheckLoginInterceptor;
...
public class LoginConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        interceptorRegistration.excludePathPatterns("/feign/defaultKaptcha/**");
        interceptorRegistration.excludePathPatterns("/login");
        interceptorRegistration.excludePathPatterns("/feign/login");
