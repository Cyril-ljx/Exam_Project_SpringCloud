...
public class TopicController {
    ...
    public ServerLayResult list(@RequestParam("page") Integer page,
        ...
        if (keyword1 != null) {
            List<Topic> topics = topicFeignService.list(page, limit, keyword1);
            ServerLayResult result = new ServerLayResult(0, "", topics.size(), topics);
            return result;
        }
        //封装数据
        ServerLayResult result = new ServerLayResult(0, "", topicFeignService.count(), topicFeignService.selectAll(page, limit));
        return result;
    }
...
//   ** /
    ...
    public Map<String, Object> del(@RequestParam("id") Integer id) {
        ...
        boolean delete = topicFeignService.del(id);
    ...
    public Map<String, Object> update(@RequestBody Topic topic) {
        Map<String, Object> dataMap = new HashMap<>();
        boolean update = topicFeignService.update(topic);
    ...
    public Map<String, Object> insert(@RequestBody Topic topic) {
        Map<String, Object> dataMap = new HashMap<>();
        boolean insert = topicFeignService.insert(topic);
    ...
    public Object upload(MultipartFile file) {
        return topicFeignService.upload(file);
    }
}